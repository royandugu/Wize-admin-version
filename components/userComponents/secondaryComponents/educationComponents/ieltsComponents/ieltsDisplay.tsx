...
const IeltsDisplay = (props: educationProp) => {
    return (
        <>
            ...
            <MainIeltsSection isAdmin={props.isAdmin} textSection={props.textSection} setTextSection={props.setTextSection} setPictureOne={props.setPictureOne} setPictureTwo={props.setPictureTwo} imageOne={props.imageOne} imageTwo={props.imageTwo} setImageOne={props.setImageOne} setImageTwo={props.setImageTwo}/>
